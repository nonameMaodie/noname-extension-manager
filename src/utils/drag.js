...
export function initDrag(el, options = {}) {
  ...
  const oDiv = el;
  const minTop =
    options.minTop || Number.parseInt(oDiv.getAttribute("drag-min-top")) || 0;
  ...
  function dragStart(e) {
    ...
    const initX = Number.parseInt(target.getAttribute("init_x"));
    const initY = Number.parseInt(target.getAttribute("init_y"));
    ...
    function dragMove(e) {
      ...
      const ml = Number.parseInt(style.marginLeft) || 0;
      const mt = Number.parseInt(style.marginTop) || 0;
      ...
      onPositionChange(target, {
        x: Number.parseInt(target.style.left) || 0,
        y: Number.parseInt(target.style.top) || 0,
      });
    }
